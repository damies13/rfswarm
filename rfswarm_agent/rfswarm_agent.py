...
class RFSwarmAgent():
	...
	def __init__(self, master=None):
		...
		if self.srcdir[-2:] == "/.":
			self.debugmsg(7, "self.srcdir[-2]: ", self.srcdir[-2:])
			self.srcdir = srcdir[0:-2]
		self.debugmsg(7, "self.srcdir: ", self.srcdir)
	...
	def create_V3_listner_file(self):
		...
		self.debugmsg(5, "listenersrc", listenersrc)
		...
		# fd.append("					lResultName.append(str(arg))")
		...
		# fd.append("					if 'lineno' in data.to_dict() and 'body' in data.parent.to_dict() and data.to_dict() in data.parent.to_dict()['body']:")
		# fd.append("						tmeslp = self.randsleep(self.sleepminimum, self.sleepmaximum)")
		# fd.append("						self.debugmsg(7, 'tmeslp: ', tmeslp)")
		# fd.append("						self.debugmsg(7, 'data.parent.to_dict(): ', data.parent.to_dict())")
	...
	def create_repeater_listner_file(self):
		...
		self.debugmsg(5, "repeaterfile", self.repeaterfile)

		# srcdir
		repeatersrc = os.path.join(self.srcdir, "resources", "RFSTestRepeater.py")
		self.debugmsg(5, "repeatersrc", repeatersrc)
