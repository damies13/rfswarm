...
first task
    [Documentation]    This is the documentation
    ...    A continued line of documentation
    [Setup]    Log To Console    Task Setup
    [Teardown]    Log To Console    Task Teardown
    [Timeout]    60
    [Tags]    first    second
    First Keyword
    ...
    Log Variables
    Log    Task executed with success, first=${first}, second=${second}

second task
    [Template]    First Keyword    # This is a comment
    [Setup]    Log To Console    Task Setup    # This is a comment
    [Teardown]    Log To Console    Task Teardown    # This is a comment
    [Timeout]    60    # This is a comment
    [Tags]    first    second    # This is a comment
    No Operation
    First Keyword
    Log To Console Task executed with success
