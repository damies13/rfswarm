...
- All monitoring groups will have 1 robot each, a delay and ramp-up of 0, and a run time calculated based on `Monitoring time before test + total plan execution time + Monitoring time after test`
