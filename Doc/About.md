...
rfswarm aims to solve this problem by allowing you to take an existing functional or regression test case written in Robot Framework, [make some minor adjustments to make the test case suitable for performance testing](Preparing_for_perf.md) and then run the Robot Framework test case as many virtual users to generate load on the application under test.
